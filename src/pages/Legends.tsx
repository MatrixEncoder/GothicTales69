...
This urban legend became popular in the 1950s and continues to be told around campfires to this day. It serves as a warning about the dangers of isolated places and the vulnerability of young couples.`,
    ...
    background: "The Hook Man is a classic example of an urban legend that has been passed down through generations. The story has its roots in the 1950s, when it was first told around campfires in the United States. The legend has since been retold and adapted in various forms of media, including films and books.",
    culturalSignificance: "The Hook Man is a cautionary tale about the dangers of isolated places and the vulnerability of young couples. The legend serves as a reminder of the importance of being aware of one's surroundings and the potential dangers that lurk in the shadows.",
    referenceLink: "https://en.wikipedia.org/wiki/The_Hook_Man"
  },
  {
    id: 2,
    title: "Bloody Mary",
...
Today, the legend has evolved into a supernatural challenge that continues to terrify those brave enough to try it. Some say she appears as a beautiful young woman, others as a horrifying corpse with blood streaming from her eyes.`,
    ...
    background: "Bloody Mary is a legendary ghost who is said to appear in mirrors when called. The origins of the legend are unclear, but it is believed to have emerged in the Victorian era.",
    culturalSignificance: "Bloody Mary is a symbol of the fear of the unknown and the supernatural. The legend has been retold and adapted in various forms of media, including films and books.",
    referenceLink: "https://en.wikipedia.org/wiki/Bloody_Mary_(folklore)"
  },
  {
    id: 3,
...
This legend appears in various forms across different cultures and continues to be reported as a real experience by drivers worldwide. The story often resurfaces around the anniversary of the supposed death, adding to its supernatural mystique.`,
    ...
    background: "The Vanishing Hitchhiker is a classic urban legend that has been retold and adapted in various forms of media. The story has its roots in the 20th century, when it was first reported in the United States.",
    culturalSignificance: "The Vanishing Hitchhiker is a cautionary tale about the dangers of picking up strangers and the supernatural consequences that can follow.",
    referenceLink: "https://en.wikipedia.org/wiki/Vanishing_hitchhiker"
  },
  {
    id: 4,
    ...
    background: "The Chupacabra is a legendary creature that is said to inhabit parts of the Americas. The first reported sightings occurred in Puerto Rico in the 1990s.",
    culturalSignificance: "The Chupacabra is a symbol of the fear of the unknown and the supernatural. The legend has been retold and adapted in various forms of media, including films and books.",
    referenceLink: "https://en.wikipedia.org/wiki/Chupacabra"
  },
  {
    id: 5,
    title: "The Wendigo",
    ...
    background: "The Wendigo is a mythological creature from Algonquian folklore. The legend has its roots in the indigenous cultures of North America.",
    culturalSignificance: "The Wendigo is a cautionary tale about the dangers of greed and the importance of community and sharing.",
    referenceLink: "https://en.wikipedia.org/wiki/Wendigo"
  },
  {
    id: 6,
    title: "The Mothman",
    ...
    background: "The Mothman is a legendary creature that was reportedly seen in Point Pleasant, West Virginia, during the 1960s.",
    culturalSignificance: "The Mothman is a symbol of mystery and has inspired numerous books, films, and festivals.",
    referenceLink: "https://en.wikipedia.org/wiki/Mothman"
  },
  {
    id: 7,
  ...
  },
  {
    ...
    background: "La Llorona is a legendary ghost from Latin American folklore. The legend has its roots in the indigenous cultures of Latin America.",
    culturalSignificance: "La Llorona is a symbol of the fear of the unknown and the supernatural. The legend has been retold and adapted in various forms of media, including films and books.",
    referenceLink: "https://en.wikipedia.org/wiki/La_Llorona"
  },
  {
    id: 9,
        ...
        {LEGENDS.map((legend, index) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-gray-400 mt-4">Background: {legend.background}</p>
              <p className="text-sm text-gray-400 mt-4">Cultural Significance: {legend.culturalSignificance}</p>
              <p className="text-sm text-gray-400 mt-4">Reference Link: <a href={legend.referenceLink} target="_blank" rel="noopener noreferrer">{legend.referenceLink}</a></p>
            </div>
          </motion.div>
        ))}
      </div>
